...
export function mergeMemoryEntry(
  ...
  if (!current.trim()) {
    return `# Shared ProDocStore memory\n\nThis file is loaded by the ProDocStore extension on every chat turn. Keep entries durable and short - things the team should remember across sessions and users.\n\n${sectionHeader}\n${bullet}\n`;
  }
